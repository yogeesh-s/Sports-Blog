	...
	<center>
		<div class="menu">
			<ul>
			  ...
			  <li style="float:right"><a class="active" href="manage_organizer.php">Manage Organizer</a></li>
			</ul>
		</div>
	</center>
	<br>
	<center><label class="heading">MANAGE ORGANIZERS</label></center>
	<center>
		<div class="container">
			<div class="card">
				<?php
					$sql = "SELECT * FROM ORGANIZER_DATA";
					...
					if(mysqli_num_rows($result)>0)
					{
						...
						while($row = mysqli_fetch_assoc($result))
						{
							echo "<tr>
									...
									<td><center><a class='btn' href='remove_organizer.php?id=".$row["ID"]."'>Delete</a></center></td>";
							if($row["MODERATION"]!="APPROVED"){
								echo"	<td><center><a class='btn2' href='approve_organizer.php?id=".$row["ID"]."'>Approve</a></center></td>";
							}
							else{
