	...
	<center>
		<div class="menu">
			<ul>
			  ...
			  <li style="float:right"><a class="active" href="live_event_handling.php">Live Event Handling</a></li>
		...
		<div class="container">
			<div class="card">
				<?php
					...
					$sql = "SELECT * FROM EVENT_DATA WHERE ORGANIZER_ID = $organizer_id AND EVENT_DATE = '$today'";
					$result = mysqli_query($conn,$sql);
					if(mysqli_num_rows($result)>0)
					{
						$sl_no = 1;
						...
						while($row = mysqli_fetch_assoc($result))
						{
							echo "<tr>
									...
									<td><center><a class='btn' href='manage_live_event.php?id=".$row["ID"]."'>Manage</a></center></td>
								</tr>";
							$sl_no++;
						}
						echo "</table>";
