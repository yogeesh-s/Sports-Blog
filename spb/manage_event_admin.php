...
<body>
	...
	<center>
		<div class="menu">
			<ul>
			  ...
			  <li style="float:right"><a class="active" href="manage_event_admin.php">Manage Event</a></li>
	...
	<center>
		<div class="container">
			<div class="card">
				<?php
					$sql = "SELECT * FROM EVENT_DATA,ORGANIZER_DATA WHERE ORGANIZER_DATA.ID = EVENT_DATA.ORGANIZER_ID";
