...
<body>
	...
	<center>
		<div class="menu">
			<ul>
			  ...
			  <li style="float:right"><a class="active" href="user_login.php">User Login</a></li>
			</ul>
		</div>
	</center>
	<div class="container">
		<div class="card">
			<form method="POST" autocomplete="off">
				<center><label class="heading">USER LOGIN</label></center>
				<br>
				<label>EMAIL ID</label>
				<input type="text" name="email_id">
				<label>PASSWORD</label>
				<input type="password" name="user_password">
				<input type="submit" class="submit" name="user_login">
				<br><br>
	...
	<?php
		if(isset($_POST['user_login']))
		{
			...
			$sql = "SELECT * FROM user_data where email_id = '$email_id' AND user_password = '$user_password'";
