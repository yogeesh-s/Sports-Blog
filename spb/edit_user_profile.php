...
<body>
	...
	<br>
	<center><label class="heading">UPDATE USER PROFILE</label></center>
	<div class="container">
		<div class="card">
		<?php
		...
		?>
			<form method="POST" autocomplete="off">
				...
				<input type="password" name="password" value="<?php echo $row["USER_PASSWORD"]; ?>" required><br>
				<label>CONFIRM PASSWORD</label><br>
				<input type="password" name="confirm_password" value="<?php echo $row["USER_PASSWORD"]; ?>" required><br>
	...
	<?php
		if(isset($_POST['register']))
		{
			...
			{
				$sql = "UPDATE USER_DATA SET NAME = '$name' ,EMAIL_ID = '$email_id' ,MOBILE_NUMBER = '$mobile_number' ,DOB = '$dob' ,ADDRESS = '$address' ,USER_PASSWORD = '$password' WHERE ID = $id";
				$result = mysqli_query($conn, $sql);  
