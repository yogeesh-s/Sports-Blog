...
<body>
	...
	<br>
	<center><label class="heading">ORGANIZER REGISTRATION</label></center>
	<div class="container">
		<div class="card">
	...
	<?php
		if(isset($_POST['register']))
		{
			...
			{
				$sql = "INSERT INTO ORGANIZER_DATA (NAME,EMAIL_ID,MOBILE_NUMBER,DOB,ADDRESS,ORGANIZER_PASSWORD,MODERATION) VALUES ('".$name."','".$email_id."','".$mobile_number."','".$dob."','".$address."','".$password."','PENDING')";
